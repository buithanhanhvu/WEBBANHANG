...
![Admin Dashboard](images/report_admin_dashboard.png)
...
![Admin - Quản lý Sản phẩm](images/report_admin_products.png)
...
![Admin - Quản lý Danh mục](images/report_admin_categories.png)
...
![Admin - Quản lý Voucher](images/report_admin_coupons.png)
...
![Admin - Quản lý Đơn hàng](images/report_admin_orders.png)
...
![Admin - Thùng rác Recycle Bin](images/report_admin_recycle_bin.png)
...
![Customer - Trang chủ](images/report_customer_homepage.png)
...
![Customer - Nhận mã giảm giá](images/report_customer_vouchers_collect.png)
...
![Customer - Ví Voucher của tôi](images/report_customer_my_vouchers.png)
...
![Customer - Chi tiết sản phẩm](images/report_customer_product_detail.png)
...
![Customer - Giỏ hàng](images/report_customer_cart.png)
...
![Customer - Trang thanh toán](images/report_customer_checkout.png)
...
![Customer - Theo dõi đơn hàng](images/report_customer_order_tracking.png)
